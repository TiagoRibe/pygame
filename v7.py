...
somV= py.mixer.Sound("vitória.mp3")
somJG= py.mixer.Sound("música_jogo.mp3")
somD= py.mixer.Sound("derrota.mp3")
somB= py.mixer.Sound("bebendo.mp3")
somExp= py.mixer.Sound("explosão.mp3")
